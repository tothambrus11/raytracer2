...
// configuration step. It creates a namespace called `raytracer2`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", raytracer2::cmake::project_name, raytracer2::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", raytracer2::cmake::project_version);
      return EXIT_SUCCESS;
    }
